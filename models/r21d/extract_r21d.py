...
from models.transforms import CenterCrop, Normalize, Resize, ToFloatTensorInZeroOne
...
class ExtractR21D(BaseExtractor):
    def __init__(self, args) -> None:
        ...
        r21d_model_cfgs = {
            ...
            "r2plus1d_34_32_ig65m_ft_kinetics": {
                ...
                "model_name_in_repo": "r2plus1d_34_32_kinetics",
                "stack_size": 32,
                "step_size": 32,
                "num_classes": 400,
                "dataset": "kinetics",
            ...
            "r2plus1d_34_8_ig65m_ft_kinetics": {
                "repo": "moabitcoin/ig65m-pytorch",
                "model_name_in_repo": "r2plus1d_34_8_kinetics",
                "stack_size": 8,
                "step_size": 8,
                "num_classes": 400,
                "dataset": "kinetics",
    ...
    def extract(self, video_path: str) -> Dict[str, np.ndarray]:
        ...
        for stack_idx, (start_idx, end_idx) in enumerate(slices):
            # inference
            output = self.name2module["model"](
                rgb[:, :, start_idx:end_idx, :, :].to(self.device)
            )
